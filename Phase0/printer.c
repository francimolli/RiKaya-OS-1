...
volatile dtpreg_t *printer = (dtpreg_t*) DEV_REG_ADDR(IL_PRINTER, 0); /* puntatore che serve per accedere ai campi destinati alla stampante queli status, command, data0 (data1 non è utilizzato nelle stampanti). */
